function validations (userData) {
    ...
    if(userData.life < 1 || userData.life > 400) error.life = 'se acepta de 1 a 400.';
    if(userData.attack < 1 || userData.attack > 400) error.attack = 'se acepta de 1 a 400.';
    if(userData.defense < 1 || userData.defense > 400) error.defense = 'se acepta de 1 a 400.';
